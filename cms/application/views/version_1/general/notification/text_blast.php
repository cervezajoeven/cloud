                ...
                <div class="body">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            ...
                            <textarea class="form-control" name="sms_message" placeholder="Enter message here..."></textarea>
                        </div>
                    ...
                    <div class="section_container">
                        <select id="section" class="form-control hidden">
                            
                            <option value="faculty">Faculty</option>
                            <?php foreach ($data['sections'] as $section_key => $section_value): ?>
                                <!-- <option><?php echo $section_value['section_name']?></option> -->
                                <option value="<?php echo $section_value['id'] ?>"><?php echo $section_value['section_name']; ?></option>
                                
                            <?php endforeach; ?>
                            
                        </select>
                    </div>
                    <input type="hidden" name="recipient" id="">
