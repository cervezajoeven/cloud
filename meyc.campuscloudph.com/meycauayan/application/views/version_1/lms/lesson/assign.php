...
<div class="brainee-page_container col-lg-12">
	<div class="brainee-page_titlebar">
		...
		<div class="brainee-page_titlebar_controls_container">
			<a><button type="submit" class="btn btn-success" id="action_add">Assign</button></a>
							          		...
							          		<ul>
							          			<?php foreach ($data['classes'] as $class_key => $class): ?>
							          				<?php if($section['id']==$class['section_id']): ?>
										          		<li data-checkstate="checked" data-jstree='{"value":<?php echo $class['id'];?>'><?php echo $class['first_name']; ?> <?php echo $class['last_name']; ?></li>
										          	<?php endif; ?>
									          	<?php endforeach; ?>
								      		</ul>
							      		</li>
